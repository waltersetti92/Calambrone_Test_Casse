...
namespace Calambrone_Test_Casse_2
{
    ...
    public partial class ucSpeaker : UserControl
    {
        ...
        public void Initial_Button()
        {
            ...
            textBox1_arrival2.Visible = false;  
        }
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            button6.Visible = false;
           label5.Visible = true;
            textBox1_arrival2.Visible = true;
            speakers.stopspeaker();
            //  timer.Enabled = false;
            // timer.Stop();
            _requestStop = true;
            _timer.Stop();
            textBox1_arrival2.Text = Convert.ToString(Decimal.Divide(second_counter, 10));
            second_counter = 0;
        }
